...
#         arr=[]
#         queryCharacters=list(queryCharacters)
#         while queryCharacters !=[]:
#             s = s[:queryIndices[0]] + queryCharacters[0] + s[queryIndices[0] + 1 :]
#             arr.append(self.longestSub(s))
#             queryCharacters.pop(0)
#             queryIndices.pop(0)
#         return arr
class Solution:
